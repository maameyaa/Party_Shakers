        ...
        <div class="container">
            <div class="navbar-header">
                ...
                if(isset($_GET['add'])){
                    ...
                    $status = $_POST['status'];
                     ...
                     $result->addEmployee($firstname,$lastname,$house,$town,$region,$hiredate, $birthdate, $phone,$email,$gender, $eusername, $password, $status);
            ...
            <div style="margin-top:7%">
                <form method="post" action="addEmployee.php">
                    <h2 class="form-title text-center" id="Login">Add Employee</h2>
                    ...
                    <div class="body">
                        ...
                        <div class="form-group">
                            ...
                            <input name="efirstname" type="text" class="form-control" id="email-modal">
                        </div>
                        <div class="form-group">
                        <h5 class="form-title"> Employee Lastname</h5>
                            <input name="elastname" type="text" class="form-control" id="password-modal">
                        </div>
                        <div class="form-group">
                        <h5 class="form-title"> Employee House</h5>
                            <input name="house" type="text" class="form-control" id="password-modal">
                        </div>
                        <div class="form-group">
                        <h5 class="form-title"> Employee Town</h5>
                            <input name="town" type="text" class="form-control" id="password-modal">
                        </div>
                        <div class="form-group">
                        <h5 class="form-title"> Employee Region</h5>
                            <input name="region" type="text" class="form-control" id="email-modal">
                        </div>
                        <div class="form-group">
                        <h5 class="form-title"> Employee Hire Date</h5>
                            <input name="hiredate" type="text" class="form-control" id="password-modal">
                        </div>
                        <div class="form-group">
                        <h5 class="form-title"> Employee Birth Date</h5>
                            <input name="birthdate" type="text" class="form-control" id="email-modal">
                        </div>
                        <div class="form-group">
                        <h5 class="form-title"> Employee Phone</h5>
                            <input name="phone" type="text" class="form-control" id="password-modal">
                        </div>
                        <div class="form-group">
                        <h5 class="form-title"> Employee Email</h5>
                            <input name="email" type="text" class="form-control" id="email-modal">
                        </div>
                        <div class="form-group">
                        <h5 class="form-title"> Employee Gender</h5>
                            <input name="gender" type="text" class="form-control" id="password-modal">
                        </div>
                        <div class="form-group">
                        <h5 class="form-title"> Employee Username</h5>
                            <input name="eusername" type="text" class="form-control" id="password-modal">
                        </div>
                         <div class="form-group">
                        <h5 class="form-title"> Employee Temporary Password</h5>
                            <input name="password" type="text" class="form-control" id="password-modal">
                        </div>
                         <div class="form-group">
                        <h5 class="form-title"> Employee Status</h5>
                            <input name="status" type="text" class="form-control" id="password-modal">
                        </div>
                        <p class="text-center">
                            <button type="submit" class="btn btn-primary" id="addition" name="addition"><i class="fa fa-sign-in"></i> New Employee </button>
                        </p>
                    </div>
                </form>
            </div>

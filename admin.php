...
<html lang="en">
    ...
    <body>
        ...
        <div class="container" style="margin-left:1%">
                <div class="col-md-6 offer" data-animate="fadeInDown">
                    <a href="addEmployee.php" class="btn btn-success btn-sm" data-animate-hover="shake"> Add Employee </a> 
                </div>
        </div>
       ...
       <div class="col-md-14" id="customer-orders">
            <div class="box">
                ...
                <p class="lead">Employee Details as follows:</p>
                <hr>
                    ...
                    <?php
                       ...
                       // Function created to easily access records in employee database
                    	...
                    	include_once("Employee.php");
                            ...
                            $obj = new employee();   
                            $part = $obj -> getEmployees();
                                             
                            $sub = new Employee();

                            //$art = $sub -> getEmployees($text);

                            $Employeesa = $sub -> searchEmployees($text);
                                ...
                                while ($row!=false){
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>{$row["gender"]}</td>
                                            <td>{$row["status"]}</td>
                                            <td> <a href='editEmployee.php?edit={$row['eno']}' class='btn btn-primary'>Edit</a></td>
                                            <td> <a href='admin.php?delete={$row['eno']}' class='btn btn-primary'>Delete</a></td>
                                        </tr>
                                    </tbody>";
                                    $row = $sub ->fetch();
                                }

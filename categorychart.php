...
*/
								...
								while($tmp_row = $obj->fetch())
								{
									$array_category[] = $tmp_row['category'];
									$array_count[] = $tmp_row['count'];
								}
//$array_count = array(40,30,20,40);
//$array_category = array("Decorations","Costume","Food","Utensils");
 /* Create and populate the pData object */ 
 $MyData = new pData();    
 $MyData->addPoints($array_count,"ScoreA");   
 $MyData->setSerieDescription("ScoreA","Application A"); 

 /* Define the absissa serie */ 
 $MyData->addPoints($array_category,"Labels"); 

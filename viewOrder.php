...
<div class="col-md-9" id="customer-orders">
                    <div class="box">
                        ...
                        $res = $sub->getStatus($ono);
                            while ($row=$sub->fetch()){
                                $sdate = $row['shippingdate'];
                        ...
                        <form method="GET" action="viewOrder.php">
                            <input type="hidden" class="form-control" name="ono" value=<?php echo $ono?>>
                               <div class="row">
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label for="price">Shipping date</label>
                                            <input type="date" class="form-control" name="sdate" value=<?php echo $sdate?>>
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label for="olevel">Recieving date</label>
    ...
    $row = $obj->changeStatus($ono,$status,$sdate,$rdate);

    if($row==false){
        echo "Order not edited";
    }else{
        echo "Order edited";

...
pingdate = '$shippingdate',
	...
	function getOrders(){
		$strQuery = "SELECT ono, cfirstname, clastname, received, shipped, shippingdate, receivedate, orderdate FROM orders, customers WHERE orders.cno = customers.cno";
	...
	function getShipping($ono){
		$strQuery = "UPDATE orders SET shipped = 'Yes' WHERE ono = $ono";

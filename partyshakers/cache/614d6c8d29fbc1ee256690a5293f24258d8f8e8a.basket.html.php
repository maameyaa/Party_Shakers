                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody> 
                                        ...
                                        <tr>
                                            <th> 1</th>
                                            <p hidden> <input type= 'number' id ="tableid" value = 1 > </p>
                                            <td>Festive grids</td>
                                            <td><input type='number' value= 0 onclick= "subtotal()" ></td>
                                            <td>45.00</td>
                                            <td class='subtotal'></td>
                                            <td><a  onclick = "deleteitem('65')" ><i class='fa fa-trash-o'></i></a></td> 
                                        </tr>
                                           
                                        <tr>
                                            <th> 2</th>
                                            <p hidden> <input type= 'number' id ="tableid" value = 2 > </p>
                                            <td>Confetti</td>
                                            <td><input type='number' value= 1 onclick= "subtotal()" ></td>
                                            <td>6.50</td>
                                            <td class='subtotal'></td>
                                            <td><a  onclick = "deleteitem('66')" ><i class='fa fa-trash-o'></i></a></td> 
                                        </tr>

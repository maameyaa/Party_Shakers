<?php
/* Smarty version 3.1.30, created on 2017-03-11 22:27:47
  from "C:\xampp\htdocs\ecommerce\PartyShakers\Version2\demo\templates\index.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_58c46bd32bb814_06681570',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '05807c3df210501aee085785db0af5ac87b735bb' => 
    array (
      0 => 'C:\\xampp\\htdocs\\ecommerce\\PartyShakers\\Version2\\demo\\templates\\index.html',
      1 => 1489266994,
      2 => 'file',
    ),
  ),
...
function content_58c46bd32bb814_06681570 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->compiled->nocache_hash = '3075158c46bd28823e4_48871903';
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="container">
                <div class="col-md-12">
                    <div id="main-slider">
                        ...
                        <div class="item">
                            <img class="img-responsive" src="img/main-slider5.jpg" alt="">
                        </div>
                    </div>
                    <!-- /#main-slider -->
                </div>
                    ...
                    <div class="product-slider">
                            ...
                            <div class="product">
                                <div class="flip-container">
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="detail.html">
                                                <img src="img/Decorations/festive_balloons.jpg" alt="" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="back">
                                            <a href="detail.html">
                                ...
                                <div class="text">
                                    <h3><a href="detail.html">Festive Balloons </a></h3>
                            ...
                            <div class="product">
                                <div class="flip-container">
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="detail.html">
                                                <img src="img/Candy_Land/alewa.jpg" alt="" class="img-responsive" height="598" width="550">
                                            </a>
                                        </div>
                                        <div class="back">
                                            <a href="detail.html">
                                                <img src="img/Candy_Land/alewa.jpg"alt="" class="img-responsive">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="text">
                                    <h3><a href="detail.html">Alewa</a></h3>
                        ...
                        <div class="item">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="detail.html">Festive Grids</a></h3>
                            ...
                            <div class="product">
                                <div class="flip-container">
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="detail.html">
                                                <img src="img/Party_Utensils/Color_cups.jpg" alt="" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="back">
                                            <a href="detail.html">
                                ...
                                <div class="text">
                                    <h3><a href="detail.html">Party Cups</a></h3>
                            ...
                            <div class="product">
                                <div class="flip-container">
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="detail.html">
                                                <img src="img/Party_Utensils/Party_napkins.jpg" alt="" class="img-responsive" >
                                            </a>
                                        </div>
                                        <div class="back">
                                            <a href="detail.html">
                                ...
                                <div class="text">
                                    <h3><a href="detail.html">Papper Napkins</a></h3>
            ...
            <div class="container" data-animate="fadeInUpBig">
                <div class="col-md-12">
                    <div class="box slideshow">
                        <h3>Get Inspired</h3>
                        <p class="lead">Get the inspiration from our world class party organizers</p>
